            ...
            <script type="text/javascript" id="janrainCaptureScript">
                ...
                function janrainDefaultSettings() {
                    var defaultSettings = {
                        ...
                        appUrl: 'https://janrainlab.rpxnow.com',
                        tokenAction: 'event',
                        // tokenUrl: '<% =this.TokenUrl %>',
                        tokenUrl: 'http://localhost:49251/TokenUrl.aspx',
                        borderColor: '#ffffff',
                        ...
                        width: 300,
                        capture: {
                            appId: '2jn4qdqu8kbunw7mebwknb7jwy',
                            captureServer: 'https://janrainlab.dev.janraincapture.com',
                            clientId: '22xcaaga55yyb8d4t4akdy4vwmnezn2t',
                            ...
                            redirectUri: 'http://localhost:49251/TokenUrl.aspx',
                            responseType: 'code',
